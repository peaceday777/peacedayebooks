...
MY_CONSUMER_KEY = RNca3E2Uz8o8F5YwNrOeki9KT
MY_CONSUMER_SECRET = WKgFfaxT2qZgJsjHx06lzDLSFHyyFUt4ZE68JxSFCjqh3GRaHq
MY_ACCESS_TOKEN_KEY = 1004460002193629194-L08XNLoR6vpZxa1NABT4WQxzf9an5y
MY_ACCESS_TOKEN_SECRET = uGTJXQbjj9GZaubeCGPqgkCkrw7pRyuD5BDLD6a0SKAMb
...
SOURCE_ACCOUNTS = ["PEACEDAY777"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
TWITTER_SOURCE_ACCOUNTS = ["PEACEDAY777"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "peaceday_ebooks"  # The name of the account you're tweeting to.
